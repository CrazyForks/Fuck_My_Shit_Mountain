...
- 审计代码库的 **20 个维度**（full 模式）：架构、安全、稳定性、性能、测试、可维护性、设计、发布、文档、配置、可观测性、数据完整性、降级、测试真实性、类型安全、前端状态、后端 API、依赖权重、代码一致性、注释覆盖率
...
```bash
python3 fuck-my-shit-mountain/scripts/report_lint.py audit-report-*.md
python3 fuck-my-shit-mountain/scripts/report_lint.py audit-report-*.html
```

它会检查残留模板占位符、必要章节、Markdown finding 字段、严重程度统计一致性，以及疑似未脱敏 secret。
